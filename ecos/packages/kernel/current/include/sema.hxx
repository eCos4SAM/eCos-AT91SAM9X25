...
#ifdef CYGVAR_KERNEL_SYNCOBJ_LIST	// Housekeeping list that tracks all semaphores

private:
    Cyg_Counting_Semaphore    		*list_next;
    static Cyg_Counting_Semaphore   *csem_list;

    void                        	add_to_list(      void );
    void                        	remove_from_list( void );
public:

    static Cyg_Counting_Semaphore   *get_list_head();
    
    Cyg_Counting_Semaphore          *get_list_next();
