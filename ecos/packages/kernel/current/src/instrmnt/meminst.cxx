...
#include <cyg/kernel/kapi.h>		   // for real time clock	
...
#ifdef CYGDBG_KERNEL_INSTRUMENT_LOG_SYSTEM_TICK	
	cyg_tick_count_t	system_tick;		// kernel real-time clock
#endif
...
#endif
#ifdef CYGDBG_KERNEL_INSTRUMENT_LOG_SYSTEM_TICK	
		p->system_tick = (Cyg_Clock::real_time_clock == NULL )?0:Cyg_Clock::real_time_clock->current_value();		// kernel real-time clock
#endif
