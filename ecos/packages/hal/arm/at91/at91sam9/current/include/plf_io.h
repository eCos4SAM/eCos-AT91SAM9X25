...
// --------------+----------+--------+------------------------------------------
// SAM9X25-0001  2011/03/21 TuPN     Update address of peripherals
// SAM9G45-0001  2011/04/15 AXONIM   Update address of peripherals
//
// =============================================================================
...
#if   defined(CYGHWR_HAL_ARM_AT91SAM9_at91sam9x25)
#include "plf_io_sam9x25.h"
...
#define AT91_TC3    (0xFFFEC000 - 0xFFFA0000)
...
//SAM9X25-0002.ADD.Start
#endif /* #ifdef CYGHWR_HAL_ARM_AT91SAM9_at91sam9x25 */
//SAM9X25-0002.ADD.End
