...
// SAM9X25-0003  2011/04/07 TuPN     Update PMC
// SAM9X25-0004  2011/04/08 TuPN     Update Control D (x25 has 4 PIO controllers)
...
//SAM9-0001.ADD.Start
//New architecture for platform
#if defined(CYGBLD_HAL_AT91_PIO_LAYOUT_H)
//IO PINs is customized and definied in the [pio_xxxxx.h]
...
#else /* CYGBLD_HAL_AT91_PIO_LAYOUT_H */
/* Old platform */
//SAM9-0001.ADD.End
...
#warning ####sam9x25.Porting ### Change PINs of DBGU ####
#define AT91_DBG_DRXD       AT91_PIN(0,0,  9) // Debug UART Receive
#define AT91_DBG_DTXD       AT91_PIN(0,0, 10) // Debug UART Transmi
#elif CYGHWR_HAL_ARM_AT91SAM9_at91sam9g45
...
#endif /* CYGHWR_HAL_ARM_AT91SAM9_at91sam9x25 */
...
#define AT91_ISI_MCK        AT91_PIN(1,1, 31) // ISI Master Clock
...
#define AT91_TC_TCLK5       AT91_PIN(1,1, 22) // Timer #5 clock

//SAM9-0001.ADD.Start
#endif /* CYGBLD_HAL_AT91_PIO_LAYOUT_H */
//SAM9-0001.ADD.End
...
// BUGBUG
//#if defined(CYGHWR_HAL_ARM_AT91SAM7) || defined(CYGHWR_HAL_ARM_AT91SAM9)
#if defined(CYGHWR_HAL_ARM_AT91SAM7) || defined(CYGHWR_HAL_ARM_AT91SAM7)
...
#define AT91_TWI_SR_SCLWS  (1 << 10) // Clock wait state
#define AT91_TWI_SR_ESAASS (1 << 11) // End of slave access
...
// Evaluate to true if the pin is using peripheral A,B,C,D,E
#define HAL_ARM_AT91_PIO_A(_pin_)               \
  (((_pin_ >> 8) & 0xff) == 0)

//SAM9X25.ADD.Start
#define HAL_ARM_AT91_PIO_B(_pin_)               \
  (((_pin_ >> 8) & 0xff) == 1)

#define HAL_ARM_AT91_PIO_C(_pin_)               \
  (((_pin_ >> 8) & 0xff) == 2)

#define HAL_ARM_AT91_PIO_D(_pin_)               \
  (((_pin_ >> 8) & 0xff) == 3)

#define HAL_ARM_AT91_PIO_E(_pin_)               \
  (((_pin_ >> 8) & 0xff) == 4)

//Set/Clear bit in the DWORD
#define HAL_ARM_AT91_PIO_SET_BIT(addr, _pin_)   {  \
            long n;                                \
            HAL_READ_UINT32( addr, n );            \
            n |= HAL_ARM_AT91_PIO_BIT(_pin_);      \
            HAL_WRITE_UINT32( addr, n);         }

#define HAL_ARM_AT91_PIO_CLR_BIT(addr, _pin_)   {  \
            long n;                                \
            HAL_READ_UINT32( addr, n );            \
            n &= ( ~HAL_ARM_AT91_PIO_BIT(_pin_));  \
            HAL_WRITE_UINT32( addr, n);         }

//Support 4 PIO Controllers (etc., sam9x25,...)
#if defined(AT91_PIO_ABCDSR1) && defined(AT91_PIO_ABCDSR2)
#define HAL_ARM_AT91_PIOX_CFG(_pin_, _nr_, _pio_base_)                  \
  ...
  if (HAL_ARM_AT91_PIO_CTRL(_pin_) == (_nr_)) {                         \
    ...
    if (HAL_ARM_AT91_PIO_A(_pin_)) { /* Peripheral A */                 \
      HAL_ARM_AT91_PIO_CLR_BIT((_pio_base_)+AT91_PIO_ABCDSR1, _pin_);   \
      HAL_ARM_AT91_PIO_CLR_BIT((_pio_base_)+AT91_PIO_ABCDSR2, _pin_);   \
    } else {                                                            \
    if (HAL_ARM_AT91_PIO_B(_pin_)) { /* Peripheral B */                 \
      HAL_ARM_AT91_PIO_SET_BIT((_pio_base_)+AT91_PIO_ABCDSR1, _pin_);   \
      HAL_ARM_AT91_PIO_CLR_BIT((_pio_base_)+AT91_PIO_ABCDSR2, _pin_);   \
    } else {                                                            \
    if (HAL_ARM_AT91_PIO_C(_pin_)) { /* Peripheral C */                 \
      HAL_ARM_AT91_PIO_CLR_BIT((_pio_base_)+AT91_PIO_ABCDSR1, _pin_);   \
      HAL_ARM_AT91_PIO_SET_BIT((_pio_base_)+AT91_PIO_ABCDSR2, _pin_);   \
    } else { /* Peripheral D */                                         \
      HAL_ARM_AT91_PIO_SET_BIT((_pio_base_)+AT91_PIO_ABCDSR1, _pin_);   \
      HAL_ARM_AT91_PIO_SET_BIT((_pio_base_)+AT91_PIO_ABCDSR2, _pin_);   \
    } } }                                                               \
  ...
  CYG_MACRO_END
#else /* AT91_PIO_ABCDSR1 && AT91_PIO_ABCDSR2 */
//SAM9X25.ADD.End
...
#endif // !AT91_PIO_ASR
//SAM9X25.ADD.Start
#endif /* AT91_PIO_ABCDSR1 && AT91_PIO_ABCDSR2 */
//SAM9X25.ADD.End
...
#define HAL_ARM_AT91_GPIO_GET(_pin_, _value_)                        \
  ...
  CYG_MACRO_END
//SAM9X25-0004.DEL #else
#elif !defined(AT91_PIOD) /* SAM9X25-0004.ADD */
//----------------------
